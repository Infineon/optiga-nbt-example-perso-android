...
import com.infineon.css.nbt_personalization.usecase_personalization.states.usecases.AdtState;
...
/**
 * Detects tag and configures it to the ADT use case
 */
public class AdtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //GUI initialization
        logoAdt = findViewById(R.id.image_logo);
        logoAdt.setImageResource(R.drawable.icon_adt_lightgrey);
        instructionText = findViewById(R.id.textView_cardTap);
        instructionText.setText(R.string.string_adt_tap);
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (!personalized && (NfcAdapter.ACTION_TECH_DISCOVERED.equals(intent.getAction())
    ...
    private void handleUsecase(ApduChannel apduChannel) {
        ...
        try {
            ...
            IState adtState = new AdtState();
            adtState.execute(apduChannel);
            setGui();
    ...
    private void setGui() {
        runOnUiThread(() -> {
            logoAdt.setImageResource(R.drawable.icon_adt_green);
            instructionText.setText(R.string.string_adt_success);
            personalized = true;
