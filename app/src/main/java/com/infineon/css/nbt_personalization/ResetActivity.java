...
/**
 * Detects tag and configures it to the default state
 */
public class ResetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //GUI initialization
        logoReset = findViewById(R.id.image_logo);
        logoReset.setImageResource(R.drawable.icon_reset_lightgrey);
        instructionText = findViewById(R.id.textView_cardTap);
        instructionText.setText(R.string.string_reset_tap);
        buttonReturn = findViewById(R.id.button_return);
        buttonReturn.setImageResource(R.drawable.icon_return_green);
    ...
    private void handleUsecase(ApduChannel apduChannel) {
        ...
        try {
            ...
            IState defaultState = new DefaultState();
            defaultState.execute(apduChannel);
            setGui();

            apduChannel.disconnect();
        } catch (Exception e) {
            runOnUiThread(() -> instructionText.setText(R.string.string_reset_error));
        }
    }
    ...
    private void setGui() {
        runOnUiThread(() -> {
            logoReset.setImageResource(R.drawable.icon_reset_green);
            instructionText.setText(R.string.string_reset_success);
            personalized = true;
